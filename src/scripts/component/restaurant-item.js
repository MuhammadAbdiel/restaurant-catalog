    ...
    this.innerHTML = `
      <a class="resto" href="#/detail/${this.restaurant.id}">
          <section class="box">
            ...
            <img class="lazyload" data-src="${CONFIG.BASE_IMAGE_URL}${this.restaurant.pictureId}" src="${CONFIG.BASE_IMAGE_URL}${
      this.restaurant.pictureId}" alt="${this.restaurant.name} Image">
